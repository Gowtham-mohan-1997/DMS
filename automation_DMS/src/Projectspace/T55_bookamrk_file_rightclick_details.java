...
public class T55_bookamrk_file_rightclick_details extends common_function{
	...
	@Test
	public void s1_bookamrk_file_details() throws InterruptedException {
		...
		Thread.sleep(1000);
		String data =Projectspace_pages.bookmarkfiledetailsdata.getText();
