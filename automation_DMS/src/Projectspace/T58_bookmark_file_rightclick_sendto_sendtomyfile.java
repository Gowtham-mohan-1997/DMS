...
public class T58_bookmark_file_rightclick_sendto_sendtomyfile extends common_function {
	...
	public void s1_bookmark_file_sendtomyfile() throws InterruptedException {
		...
		utility.clickWithWait(Projectspace_pages.bookmarkfilesendtomyfile);
//		Projectspace_pages.bookmarkfilesendtomyfile.click();
		...
		String expecteddata = "File sharedTo :My Files successfully.";
