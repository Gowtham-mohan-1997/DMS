...
public class T67_bookmark_file_rightclick_lock extends common_function{
	...
	@Test
	public void s1_bookmark_file_lockandunlock() throws InterruptedException {
		...
		utility.clickWithWait(Projectspace_pages.lock);
		...
		action1.contextClick(Projectspace_pages.filepdf).perform();

		utility.clickWithWait(Projectspace_pages.unlock);
