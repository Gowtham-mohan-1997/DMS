...
public class T11_folder_rightclick_rename extends common_function{
	...
	public void s1_rename_onfolderdropdown() throws InterruptedException {
		...
		Projectspace_pages.foldername.sendKeys(properties.getProperty("foldername2"));
		Thread.sleep(1000);

		Projectspace_pages.save.click();
		Thread.sleep(2000);
		Projectspace_pages.search.sendKeys(properties.getProperty("foldername2"));
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		Projectspace_pages.renamedropdown.click();

		Projectspace_pages.foldernameinrename.clear();

		Projectspace_pages.foldernameinrename.sendKeys(properties.getProperty("renamefolder"));
