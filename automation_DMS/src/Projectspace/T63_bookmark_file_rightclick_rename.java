...
public class T63_bookmark_file_rightclick_rename extends common_function{
	...
	public void s1_bookmark_file_rename() throws InterruptedException {
		...
		utility.clickWithWait(Projectspace_pages.bookmarkfilerename);

		Projectspace_pages.foldernameonrename.clear();

		Projectspace_pages.foldernameonrename.sendKeys(properties.getProperty("renamefile"));

		utility.clickWithWait(Projectspace_pages.saverename);
