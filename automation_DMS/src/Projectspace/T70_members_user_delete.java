...
public class T70_members_user_delete extends common_function {
	...
	public void s1_members_searchanddelete() throws InterruptedException {
		...
		Thread.sleep(1000);
		Projectspace_pages.memberssearch.sendKeys(properties.getProperty("user1"));
		Thread.sleep(1000);
		Projectspace_pages.memberssearch.sendKeys(Keys.ENTER);
		Thread.sleep(1000);
		utility.clickWithWait(Projectspace_pages.membersdelete);
