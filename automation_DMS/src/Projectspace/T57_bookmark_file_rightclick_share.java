...
public class T57_bookmark_file_rightclick_share extends common_function {
	...
	public void s1_bookmark_file_share() throws InterruptedException {
		...
		Projectspace_pages.bookmarkfileshare.click();
		Thread.sleep(1000);
		try {
			Projectspace_pages.bookmarkfilesharecopylink.click();
