...
public class T68_bookmark_file_rightclick_delete extends common_function{
	...
	public void s1_bookmark_file_delete() throws InterruptedException {
		...
		utility.clickWithWait(Projectspace_pages.bookmarkfiledelete);

		utility.clickWithWait(Projectspace_pages.deletepopup);
