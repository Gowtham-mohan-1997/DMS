...
public class T49_create_sdnote_using_createbutton_toprightcorner extends common_function{
	...
	public void s1_create_sdnote() throws InterruptedException {
		...
		for (int i = 0; i < 20; i++) {
			try {
				...
				Projectspace_pages.sdnote.click();
		Thread.sleep(500);
		break;
			} catch (Exception f) {
				Thread.sleep(1000);
		...
		Projectspace_pages.sdnotenamed.sendKeys(properties.getProperty("sdnote"));
		Thread.sleep(500);
	//	try {
		...
		Thread.sleep(500);
		Projectspace_pages.sdnotesavebutton.click();
		Thread.sleep(1000);
