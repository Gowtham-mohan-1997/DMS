...
public class T65_bookmark_file_rightclick_copy extends common_function{
	...
	public void s1_bookmark_file_copy() throws InterruptedException {
		...
		utility.clickWithWait(Projectspace_pages.movefolderonfile);

		utility.clickWithWait(Projectspace_pages.copybuttononfile);

		Thread.sleep(3000);
		String actualdata = Projectspace_pages.actualelement.getText();
		String expecteddata = "Files/Folders Copied successfully";
