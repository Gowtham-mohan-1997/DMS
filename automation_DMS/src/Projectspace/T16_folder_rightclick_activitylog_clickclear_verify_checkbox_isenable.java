...
public class T16_folder_rightclick_activitylog_clickclear_verify_checkbox_isenable extends common_function{
	...
	public void s1_activitylog_clickclear_verify_checkbox_isenable() throws InterruptedException {
		...
		Thread.sleep(500);
		Projectspace_pages.clearbuttonfolderactivity.click();
		Thread.sleep(500);
