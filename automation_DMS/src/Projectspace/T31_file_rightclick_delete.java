...
public class T31_file_rightclick_delete extends common_function{
	...
	public void s1_delete_onfile() throws InterruptedException {
		...
		Thread.sleep(500);
		Projectspace_pages.foldername.sendKeys(properties.getProperty("foldername6"));
		Thread.sleep(500);
		Projectspace_pages.save.click();
		Thread.sleep(500);
		Projectspace_pages.search.sendKeys(properties.getProperty("foldername6"));
		Thread.sleep(500);
        ...
        Thread.sleep(500);
        Projectspace_pages.deleteonfile.click();
        Thread.sleep(500);
        Projectspace_pages.deletepopuponfile.click();
        Thread.sleep(500);
