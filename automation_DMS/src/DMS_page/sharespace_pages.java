...
public class sharespace_pages {
	...
	@FindBy(css = "div#home-documents-list div[id=\"company\"]")
...
//    public static WebElement folderclick;
	...
	@FindBy(css="div#my_share_received_grid span[class=\"title file_size_title ellipses\"]")
...
//
	...
	@FindBy(css="ul#share_bookmarks_c_menu span[class=\"k-sprite icon-ic_context_upload\"]")
	public static WebElement uploadfileonbookmark;

	@FindBy(xpath="//*[@id=\"share_bookmarks_c_menu\"]/li[3]/span")
	public static WebElement createfolderonbookmark;

	@FindBy(css="ul#share_bookmarks_c_menu span[class=\"k-sprite icon-ic_context_download\"]")
	public static WebElement downloadonbookmark;

	@FindBy(css="ul#share_bookmarks_c_menu span[class=\"k-sprite icon-ic_context_rename\"]")
	public static WebElement renameonbookmark;

	@FindBy(id="folder_name")
	public static WebElement folderrenameonbookmark;

	@FindBy(xpath="//*[@id=\"share_bookmarks_c_menu\"]/li[8]/span")
	public static WebElement movefolderonbookmark;

	@FindBy(css="ul#share_bookmarks_c_menu span[class=\"k-sprite icon-ic_context_trash\"]")
	public static WebElement deleteonbookmark;

	@FindBy(css="ul#share_bookmarks_c_menu span[class=\"k-sprite icon-ic_context_share\"]")
	...
	@FindBy(xpath="//*[@id=\"context-recycle-menu-grid_mn_active\"]/span")
	public static WebElement recyclepinrestore;

	@FindBy(xpath="//*[@id=\"context-recycle-menu-grid\"]/li[2]/span")
	...
	@FindBy(xpath="//*[@id=\"grid_mybookmark_list\"]/div[2]/table/tbody/tr[6]/td[2]")
	public static WebElement bookmarkfileclick1;

	@FindBy(xpath="//li[@id='share_bookmarks_c_menu_mn_active']/span")
	...
	@FindBy(xpath="//ul[@id='share_bookmarks_c_menu']/li[4]/span")
	public static WebElement bookmarkfiledownload;

	@FindBy(xpath="//ul[@id='share_bookmarks_c_menu']/li[6]/span")
	...
	@FindBy(xpath="//*[@id=\"share_bookmarks_c_menu\"]/li[7]/span")
