...
public class T43_bookmark_folder_rightclick_createfolder extends common_function{
	...
	Partnerspace_pages.projectsearch.sendKeys(Keys.ENTER);
		...
		Thread.sleep(500);
		Partnerspace_pages.createfolderonbookmark.click();
		Thread.sleep(500);
		Partnerspace_pages.foldername.sendKeys(properties.getProperty("bookmarkfoldercreate"));
		Thread.sleep(500);
