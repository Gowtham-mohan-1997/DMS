...
public class T36_advancesearch extends common_function{
	...
	public void s1_advancesearch() throws InterruptedException {
		...
		Thread.sleep(1000);
		Partnerspace_pages.advancesearchbutton.click();
		Thread.sleep(500);
		Partnerspace_pages.advancesearchtextbox.sendKeys(properties.getProperty("advancesearch"));
		Thread.sleep(500);
		Partnerspace_pages.advancesearchtextbox.sendKeys(Keys.ENTER);
		Thread.sleep(2000);
		String actualdata1 =Partnerspace_pages.filename.getText();
...
//		Assert.assertEquals(actualdata1.toLowerCase(), expecteddata1.toLowerCase());
		...
		Partnerspace_pages.closebuttonadvancesearch.click();
		Thread.sleep(500);
		Partnerspace_pages.advancesearchbutton.click();
		Thread.sleep(500);
		Partnerspace_pages.advancesearchtextbox.sendKeys(properties.getProperty("advancesearchcontent"));
		Thread.sleep(500);
		Partnerspace_pages.advancesearchtextbox.sendKeys(Keys.ENTER);
		Thread.sleep(2000);
		String actualdata2 =Partnerspace_pages.filename.getText();
