...
public class T13_folder_rightclick_delete extends common_function{
	...
	public void s1_deletefolder_onfolderdropdown() throws InterruptedException {
		...
		Thread.sleep(500);
		Partnerspace_pages.foldername.sendKeys(properties.getProperty("deletename"));
		Thread.sleep(500);
		Partnerspace_pages.save.click();
		Thread.sleep(2000);
		Partnerspace_pages.search.sendKeys(properties.getProperty("deletename"));
		Thread.sleep(2000);
		...
		Thread.sleep(500);
		Partnerspace_pages.deletedropdown.click();
		Thread.sleep(2000);
