...
public class T50_recyclepin_folder_rightclick_restore extends common_function{
	...
	public void s1_recyclepin_restore() throws InterruptedException {
		...
		Thread.sleep(500);
		Partnerspace_pages.recyclepin.click();
		Thread.sleep(3000);
		Actions action = new Actions(driver);
		action.contextClick(Partnerspace_pages.recyclepinfolder).perform();
		Thread.sleep(3000);
		Partnerspace_pages.recyclepinrestore.click();
		Thread.sleep(500);
