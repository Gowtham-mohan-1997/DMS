...
public class T61_bookmark_file_rightclick_sendto_sendtoproject  extends common_function{
	...
	public void s1_bookmark_file_sendtoproject() throws InterruptedException {
		...
		utility.clickWithWait(Partnerspace_pages.bookmarkfilesendtoproject);
