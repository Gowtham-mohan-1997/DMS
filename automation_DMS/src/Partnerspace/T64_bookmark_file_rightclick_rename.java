...
public class T64_bookmark_file_rightclick_rename extends common_function{
	...
	public void s1_bookmark_file_rename() throws InterruptedException {
		...
		utility.clickWithWait(Partnerspace_pages.bookmarkfilerename);

		Partnerspace_pages.foldernameonrename.clear();

		Partnerspace_pages.foldernameonrename.sendKeys(properties.getProperty("renamefile"));

		utility.clickWithWait(Partnerspace_pages.saverename);
