...
public class T12_folder_rightclick_move extends common_function {
	...
	public void s1_move_onfolderdropdown() throws InterruptedException {
		...
		Thread.sleep(2000);
		Partnerspace_pages.foldername.sendKeys(properties.getProperty("foldername3"));
		Thread.sleep(2000);
		Partnerspace_pages.save.click();
		Thread.sleep(2000);
		Partnerspace_pages.search.sendKeys(properties.getProperty("foldername3"));
		Thread.sleep(500);
		...
		Thread.sleep(500);
		Partnerspace_pages.movedropdownfolder.click();
		Thread.sleep(500);
		Partnerspace_pages.clickfoldermove.click();
		Thread.sleep(500);
