...
public class T68_bookmark_file_rightclick_lock extends common_function{
	...
	public void s1_bookmark_file_lockandunlock() throws InterruptedException {
		...
		utility.clickWithWait(Partnerspace_pages.lock);
		...
		utility.clickWithWait(Partnerspace_pages.unlock);
