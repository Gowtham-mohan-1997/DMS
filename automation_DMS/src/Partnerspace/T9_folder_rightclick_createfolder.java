...
public class T9_folder_rightclick_createfolder extends common_function{
	...
	@Test
	public void s1_createfolder_onfolderdropdown() throws InterruptedException {
	...
	Partnerspace_pages.projectsearch.sendKeys(Keys.ENTER);
		...
		Thread.sleep(500);
		Partnerspace_pages.dropdownfoldercreate.click();
		Thread.sleep(500);
		Partnerspace_pages.foldercreatename.sendKeys(properties.getProperty("foldername1"));
		Thread.sleep(500);
		Partnerspace_pages.savebutton.click();
		Thread.sleep(500);
