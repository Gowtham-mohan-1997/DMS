...
public class T25_file_rightclick_sendto_sendtosharespace extends common_function{
	...
	@Test
	public void s1_sendto_sharespace_onfile() throws InterruptedException {
        ...
        Thread.sleep(500);
        Partnerspace_pages.sharespace.click();
        Thread.sleep(500);
        Partnerspace_pages.sharespacefolder.click();
        Thread.sleep(500);
