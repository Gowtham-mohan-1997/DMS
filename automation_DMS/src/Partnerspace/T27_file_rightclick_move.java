...
public class T27_file_rightclick_move extends common_function{
	...
	public void s1_move_onfile() throws InterruptedException {
		...
		Thread.sleep(500);
		Partnerspace_pages.foldername.sendKeys(properties.getProperty("foldername5"));
		Thread.sleep(500);
		Partnerspace_pages.save.click();
		Thread.sleep(500);
		Partnerspace_pages.search.sendKeys(properties.getProperty("foldername5"));
		Thread.sleep(500);
        ...
        Thread.sleep(500);
        Partnerspace_pages.movefolderonfile.click();
        Thread.sleep(500);
        Partnerspace_pages.movebuttononfile.click();
        Thread.sleep(500);
