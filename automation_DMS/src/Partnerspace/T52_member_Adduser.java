...
public class T52_member_Adduser extends common_function{
	...
	public void s1_Adduser_inmember() throws InterruptedException {
		...
		Thread.sleep(1000);
		Partnerspace_pages.users.click();
		Thread.sleep(1000);
		Partnerspace_pages.Addusers.click();
		Thread.sleep(1000);
		Partnerspace_pages.searchusers.sendKeys(properties.getProperty("user2"));
		Thread.sleep(500);
		Partnerspace_pages.searchusers.sendKeys(Keys.ENTER);
		Thread.sleep(500);
		Partnerspace_pages.usersclick.click();
		Thread.sleep(500);
