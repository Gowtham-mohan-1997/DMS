...
public class T46_bookmark_folder_rightclick_move extends common_function {
	...
	public void s1_movefolder_onbookmark() throws InterruptedException {
		...
		Thread.sleep(500);
		Partnerspace_pages.movefolderonbookmark.click();
		Thread.sleep(500);
		Partnerspace_pages.bookmarkmovefolderclick.click();
		Thread.sleep(500);
		Partnerspace_pages.movebutton.click();
		Thread.sleep(500);
