...
public class T22_file_rightclick_sendto_sendtodepartment extends common_function{
	...
	@Test
	public void s1_sendto_department_onfile() throws InterruptedException {
        ...
        Thread.sleep(500);
        Partnerspace_pages.departmentsendto.click();
        Thread.sleep(500);
        Partnerspace_pages.departmentfolder.click();
        Thread.sleep(500);
