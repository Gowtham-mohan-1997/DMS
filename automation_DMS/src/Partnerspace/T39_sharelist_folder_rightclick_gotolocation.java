...
public class T39_sharelist_folder_rightclick_gotolocation extends common_function{
	...
	public void s1_sharelist_gotolocation() throws InterruptedException {
		...
		Thread.sleep(500);
		Partnerspace_pages.gotolocation.click();
		Thread.sleep(1000);
		String actualdata =Partnerspace_pages.filenameingotolocation.getText();
