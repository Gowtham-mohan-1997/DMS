...
public class T71_members_user_delete extends common_function{
	...
	@Test
	public void s1_members_searchanddelete() throws InterruptedException {
		...
		Thread.sleep(1000);
		Partnerspace_pages.memberssearch.sendKeys(properties.getProperty("user1"));
		Thread.sleep(1000);
		Partnerspace_pages.memberssearch.sendKeys(Keys.ENTER);
		Thread.sleep(1000);
		utility.clickWithWait(Partnerspace_pages.membersdelete);
