...
public class T38_sharelist_folder_rightclick_unshare extends common_function{
	...
	@Test
	public void s1_sharelist_unshare() throws InterruptedException {
		...
		action.contextClick(Partnerspace_pages.foldersharelist).perform();
		Thread.sleep(500);
		Partnerspace_pages.unshare.click();
		Thread.sleep(500);
		String actualdata =Partnerspace_pages.actualelement.getText();
		System.out.println(actualdata);
		String expecteddata ="Resource Unshared Successfully.";
