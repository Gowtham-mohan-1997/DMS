...
public class T23_file_rightclick_sendto_sendtoproject extends common_function{
	...
	@Test
	public void s1_sendto_project_onfile() throws InterruptedException {
        ...
        Thread.sleep(500);
        Partnerspace_pages.project.click();
        Thread.sleep(500);
        Partnerspace_pages.projectfolder.click();
        Thread.sleep(500);
