...
public class T45_bookmark_folder_rightclick_rename extends common_function{
	...
	Partnerspace_pages.projectsearch.sendKeys(Keys.ENTER);
		...
		Thread.sleep(500);
		Partnerspace_pages.renameonbookmark.click();
		Thread.sleep(500);
		Partnerspace_pages.folderrenameonbookmark.clear();
		Thread.sleep(500);
		Partnerspace_pages.folderrenameonbookmark.sendKeys(properties.getProperty("bookmarkrename"));
		Thread.sleep(500);
