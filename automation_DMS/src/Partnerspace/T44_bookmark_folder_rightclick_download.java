...
public class T44_bookmark_folder_rightclick_download extends common_function{
	...
	@Test
	public void s1_bookmark_download() throws InterruptedException {
	...
	Partnerspace_pages.projectsearch.sendKeys(Keys.ENTER);
		...
		Thread.sleep(500);
		Partnerspace_pages.downloadonbookmark.click();
		Thread.sleep(500);
