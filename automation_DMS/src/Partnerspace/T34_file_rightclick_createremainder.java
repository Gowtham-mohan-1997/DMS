...
public class T34_file_rightclick_createremainder extends common_function{
	...
	public void s1_createremainder_onfile() throws InterruptedException {
		...
		Thread.sleep(500);
		Partnerspace_pages.createremainternametextbox.sendKeys(properties.getProperty("remaindername"));
		Thread.sleep(500);
		Partnerspace_pages.createremaintercalender.click();
		Thread.sleep(500);
		Partnerspace_pages.createremainterdate.click();
		Thread.sleep(500);
		Partnerspace_pages.createremaintersave.click();
		Thread.sleep(500);
