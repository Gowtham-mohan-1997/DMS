...
public class T24_file_rightclick_sendto_sendtopartnerspace extends common_function{
	...
	@Test
	public void s1_sendto_partnerspace_onfile() throws InterruptedException {
        ...
        Thread.sleep(500);
        Partnerspace_pages.sendtodropdownonfile.click();
        Thread.sleep(500);
        Partnerspace_pages.partnerproject.click();
        Thread.sleep(500);
        Partnerspace_pages.partnerprojectfolder.click();
        Thread.sleep(500);
        Partnerspace_pages.sendbutton.click();
        Thread.sleep(1000);
