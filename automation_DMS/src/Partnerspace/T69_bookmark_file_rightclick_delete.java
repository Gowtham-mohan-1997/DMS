...
public class T69_bookmark_file_rightclick_delete  extends common_function{
	...
	public void s1_bookmark_file_delete() throws InterruptedException {
		...
		utility.clickWithWait(Partnerspace_pages.bookmarkfiledelete);

		utility.clickWithWait(Partnerspace_pages.deletepopup);
