...
public class T7_folder_rightclick_properties extends common_function{
	...
	public void s1_properties_onfolder() throws InterruptedException {
		...
		Thread.sleep(500);
		Partnerspace_pages.properties.click();
		Thread.sleep(500);
		String text = Partnerspace_pages.propertiesdata.getText();
		System.out.println("text" + text);
		Partnerspace_pages.advance.click();
		Thread.sleep(500);
		Partnerspace_pages.advancediscription.sendKeys("advance");
		Thread.sleep(500);
		Partnerspace_pages.advancediscriptionsave.click();
		Thread.sleep(500);
		String actualdata =Partnerspace_pages.actualelement.getText();
		System.out.println(actualdata);
		Partnerspace_pages.closebutton.click();
}
}
