...
public class T24_file_rightclick_move extends common_function {
	...
	@Test
	public void s1_verify_move_onfile() throws InterruptedException {
		...
		Thread.sleep(500);
		MyFiles_page.foldername.sendKeys(properties.getProperty("foldername5"));
		Thread.sleep(500);
		MyFiles_page.save.click();
		Thread.sleep(500);
		MyFiles_page.search.sendKeys(properties.getProperty("foldername5"));
		Thread.sleep(1000);
		...
		Thread.sleep(500);
		MyFiles_page.movefolderonfile.click();
		Thread.sleep(500);
