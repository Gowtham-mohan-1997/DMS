...
public class T52_bookmark_file_rightclick_delete extends common_function {
	...
	public void s1_sharewithme_openlink() throws InterruptedException {
		...
		Thread.sleep(1000);
		MyFiles_page.bookmarkdelete.click();
		Thread.sleep(500);
		MyFiles_page.deletepopup.click();
		Thread.sleep(500);
		String actualdata = MyFiles_page.actualelement.getText();
		String expecteddata ="successFolder deleted successfully.";
