...
public class T64_bookmark_file_rightclick_sendto_sendtosharespace extends common_function{
	...
	public void s1_bookmark_file_sendtosharespace() throws InterruptedException {
		...
		utility.clickWithWait(MyFiles_page.bookmarkfilesendtosharespace);

		utility.clickWithWait(MyFiles_page.bookmarkfilesharespacefolderclick);
