...
public class T63_bookmark_file_rightclick_sendto_sendtopartner extends common_function{
	...
	@Test
	public void s1_file_sendtopartner() throws InterruptedException {
		...
		utility.clickWithWait(MyFiles_page.bookmarkfilesendtopartner);
