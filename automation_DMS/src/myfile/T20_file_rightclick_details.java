...
public class T20_file_rightclick_details extends common_function{
	...
	@Test
	public void s1_verify_details_infile() throws InterruptedException {
        ...
        Thread.sleep(500);
        MyFiles_page.details.click();
        Thread.sleep(500);
        String details =MyFiles_page.detailsdata.getText();
        System.out.println(details);
        MyFiles_page.close.click();
