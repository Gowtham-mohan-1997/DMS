...
public class T50_bookmark_file_rightclick_rename extends common_function{
	...
	public void s1_sharewithme_openlink  () throws InterruptedException {
		...
		Thread.sleep(1000);
		MyFiles_page.bookmarkrename.click();
		Thread.sleep(1000);
		MyFiles_page.foldernameonrename.clear();
		Thread.sleep(1000);
		MyFiles_page.foldernameonrename.sendKeys(properties.getProperty("bookmarkrename"));
		Thread.sleep(1000);
	MyFiles_page.saverename.click();
	Thread.sleep(1000);
	String actualdata = MyFiles_page.actualelement.getText();
	String expecteddata ="successFolder is renamed Successfully";
