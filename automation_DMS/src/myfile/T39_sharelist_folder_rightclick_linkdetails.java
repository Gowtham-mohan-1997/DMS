...
public class T39_sharelist_folder_rightclick_linkdetails extends common_function{
	...
	public void s1_sharelist_linkdetails_shown () throws InterruptedException {
		...
		Thread.sleep(2000);
		MyFiles_page.linkdetails.click();
		Thread.sleep(2000);
		String actualdata =MyFiles_page.linkdetailsinsharedetails.getText();
		System.out.println(actualdata);
		Thread.sleep(2000);
		MyFiles_page.linkdetailscancelbutton.click();
		}
}
