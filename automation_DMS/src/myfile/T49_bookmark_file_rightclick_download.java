...
public class T49_bookmark_file_rightclick_download extends common_function{
	...
	public void s1_sharewithme_openlink  () throws InterruptedException {
		...
		Thread.sleep(1000);
		MyFiles_page.bookmarkdownload.click();
		Thread.sleep(1000);
		String actualdata = MyFiles_page.actualelement.getText();
		String expecteddata ="infoFolder created successfully.";
