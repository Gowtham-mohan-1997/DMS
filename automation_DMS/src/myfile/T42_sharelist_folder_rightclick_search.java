...
public class T42_sharelist_folder_rightclick_search extends common_function{
	...
	public void s1_sharelist_linkdetails_shown () throws InterruptedException {
	    ...
	    Thread.sleep(2000);
	    MyFiles_page.sharelistsearchbutton.sendKeys(properties.getProperty("searchfoldersharebyme"));
	    MyFiles_page.sharelistsearchbutton.sendKeys(Keys.ENTER);
	    String actualdata =MyFiles_page.foldersharelist.getText();
	System.out.println(actualdata);
	 Thread.sleep(1000);
	 MyFiles_page.sharelistbackbutton.click();
	 Thread.sleep(2000);
	 lookup_function.Shareclickbutton.click();
	    Thread.sleep(1000);
	    lookup_function.selectLookupValue1("Shared With Me");
	    Thread.sleep(2000);
	    MyFiles_page.sharelistsearchbutton.sendKeys(properties.getProperty("searchfoldersharewithme"));
	    MyFiles_page.sharelistsearchbutton.sendKeys(Keys.ENTER);
	    String actualdata1 =MyFiles_page.foldersharelist.getText();
