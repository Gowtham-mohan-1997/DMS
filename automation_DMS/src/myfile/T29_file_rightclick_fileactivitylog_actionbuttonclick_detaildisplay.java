...
public class T29_file_rightclick_fileactivitylog_actionbuttonclick_detaildisplay  extends common_function{
	...
	@Test
	public void s1_verify_actionbuttonclick_detaildisplay_onfile() throws InterruptedException {
		...
		Thread.sleep(500);
		MyFiles_page.FolderActions.click();
		Thread.sleep(500);
		MyFiles_page.FolderShareActions.click();
		Thread.sleep(500);
		MyFiles_page.FolderRecycleBinActions.click();
		Thread.sleep(500);
		MyFiles_page.FolderAutomationActions.click();
		Thread.sleep(500);
		MyFiles_page.FolderEmailActions.click();
		Thread.sleep(500);
		MyFiles_page.clearbuttoninactivitylog.click();
	}
}
