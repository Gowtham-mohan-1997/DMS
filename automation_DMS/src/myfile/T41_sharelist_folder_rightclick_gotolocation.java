...
public class T41_sharelist_folder_rightclick_gotolocation extends common_function{
	...
	public void s1_sharelist_linkdetails_shown () throws InterruptedException {
		...
		Thread.sleep(2000);
		MyFiles_page.gotolocation.click();
		Thread.sleep(2000);
		String actualdata =MyFiles_page.location.getText();
