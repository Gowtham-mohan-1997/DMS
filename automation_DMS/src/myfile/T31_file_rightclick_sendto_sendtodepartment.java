...
public class T31_file_rightclick_sendto_sendtodepartment extends common_function {
...
@Test
public void s1_verify_sendto_department_onfile () throws InterruptedException {
...
//    action1.moveToElement( MyFiles_page.sendtobutton).perform();
//    Thread.sleep(500);
//    lookup_function.selectLookupdepartment("Send To Department");
//    Thread.sleep(500);
    MyFiles_page.sendtobutton.click();
    Thread.sleep(500);
    MyFiles_page.department.click();
    Thread.sleep(500);
    MyFiles_page.departmentfolder.click();
    Thread.sleep(500);
    MyFiles_page.sendbutton.click();
    Thread.sleep(2000);
