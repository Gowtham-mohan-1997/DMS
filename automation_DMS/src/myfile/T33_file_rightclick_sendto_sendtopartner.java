...
public class T33_file_rightclick_sendto_sendtopartner extends common_function{
	...
	@Test
	public void s1_verify_sendto_partnerproject_onfile () throws InterruptedException {
	    ...
	    Thread.sleep(500);
	    MyFiles_page.partnerproject.click();
	    Thread.sleep(500);
	    MyFiles_page.partnerprojectfolder.click();
	    Thread.sleep(500);
