...
public class T32_file_rightclick_sendto_sendtoproject extends common_function{
	...
	@Test
	public void s1_verify_sendto_project_onfile  () throws InterruptedException {
	    ...
	    Thread.sleep(500);
	    MyFiles_page.project.click();
	    Thread.sleep(500);
	    MyFiles_page.projectfolder.click();
	    Thread.sleep(500);
