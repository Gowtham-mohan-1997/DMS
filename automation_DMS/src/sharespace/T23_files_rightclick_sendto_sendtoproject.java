...
public class T23_files_rightclick_sendto_sendtoproject  extends common_function{
	...
	@Test
	public void s1_sendto_project() throws InterruptedException {
		...
		Thread.sleep(500);
		sharespace_pages.project.click();
		Thread.sleep(500);
		sharespace_pages.projectfolder.click();
		Thread.sleep(500);
