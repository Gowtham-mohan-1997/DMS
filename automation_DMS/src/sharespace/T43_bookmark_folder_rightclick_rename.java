...
public class T43_bookmark_folder_rightclick_rename extends common_function{
	...
	public void s1_rename_onbookmark() throws InterruptedException {
		...
		Thread.sleep(500);
		sharespace_pages.renameonbookmark.click();
		Thread.sleep(500);
		sharespace_pages.folderrenameonbookmark.clear();
		Thread.sleep(500);
		sharespace_pages.folderrenameonbookmark.sendKeys(properties.getProperty("bookmarkrename"));
		Thread.sleep(500);
