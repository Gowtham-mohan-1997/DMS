...
public class T35_sharelist_folder_rightclick_linkdetails extends common_function{
	...
	public void s1_sharelist_linkdetails_onfolder() throws InterruptedException {
		...
		Thread.sleep(500);
		sharespace_pages.linkdetails.click();
		Thread.sleep(500);
		sharespace_pages.linkdetailscancelbutton.click();
