...
public class T16_folder_rightclick_activitylog_verify_download extends common_function{
	...
	@Test
	public void s1_activitylog_verify_download() throws InterruptedException {
		...
		Thread.sleep(500);
		sharespace_pages.downloadbutytonfolderactivity.click();
		Thread.sleep(500);
		sharespace_pages.csvdownloadfolderactivity.click();
		Thread.sleep(500);
		sharespace_pages.downloadbutytonfolderactivity.click();
		Thread.sleep(500);
		sharespace_pages.exceldownloadfolderactivity.click();
		Thread.sleep(500);
