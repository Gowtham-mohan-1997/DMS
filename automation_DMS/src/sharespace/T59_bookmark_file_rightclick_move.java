...
public class T59_bookmark_file_rightclick_move extends common_function{
	...
	public void s1_bookmark_file_move() throws InterruptedException {
		...
		utility.clickWithWait(sharespace_pages.movebutton);

		Thread.sleep(3000);
		String actualdata = sharespace_pages.actualelement.getText();
		String expecteddata = "Files/Folder(s) moved successfully";
