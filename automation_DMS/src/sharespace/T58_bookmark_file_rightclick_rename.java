...
public class T58_bookmark_file_rightclick_rename extends common_function{
	...
	public void s1_bookmark_file_rename() throws InterruptedException {
		...
		utility.clickWithWait(sharespace_pages.bookmarkfilerename);

		sharespace_pages.foldernameonrename.clear();

		sharespace_pages.foldernameonrename.sendKeys(properties.getProperty("renamefile"));

		utility.clickWithWait(sharespace_pages.saverename);
