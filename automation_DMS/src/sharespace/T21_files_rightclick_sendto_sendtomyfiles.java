...
public class T21_files_rightclick_sendto_sendtomyfiles extends common_function {
	...
	@Test
	public void s1_sendto_myfiles() throws InterruptedException {
		...
		Thread.sleep(500);
		sharespace_pages.myfilessendto.click();
		Thread.sleep(500);
		sharespace_pages.myfilesfolder.click();
		Thread.sleep(500);
