...
public class T24_files_rightclick_sendto_sendtopartner extends common_function{
	public void login_userui() throws InterruptedException {
		...
		public void s1_sendto_partner() throws InterruptedException {
			...
			Thread.sleep(500);
			sharespace_pages.partnerproject.click();
			Thread.sleep(500);
			sharespace_pages.partnerprojectfolder.click();
			Thread.sleep(500);
