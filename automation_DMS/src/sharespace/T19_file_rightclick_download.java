...
public class T19_file_rightclick_download extends common_function{
	...
	@Test
	public void s1_verify_download_onfile() throws InterruptedException {
        ...
        Thread.sleep(2000);
        sharespace_pages.downloadinfile.click();
        Thread.sleep(2000);
        String actualdata =sharespace_pages.actualelement.getTagName();
        System.out.println(actualdata);
        String expecteddata="div";
