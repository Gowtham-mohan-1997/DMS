...
public class T63_bookmark_file_partnerspace extends common_function{
	...
	@Test
	public void s1_bookmark_file_partnerspace() throws InterruptedException {
		...
		utility.clickWithWait(Projectspace_pages.bookmarkfilesendtopartner);

		utility.clickWithWait(Projectspace_pages.bookmarkfiledepartmentfolderclick);
