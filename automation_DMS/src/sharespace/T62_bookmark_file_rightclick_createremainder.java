...
public class T62_bookmark_file_rightclick_createremainder extends common_function{
	...
	public void s1_sharewithme_openlink() throws InterruptedException {
		...
		utility.clickWithWait(sharespace_pages.bookmarkfileremainter);

		sharespace_pages.bookmarkfileremaintertext.sendKeys(properties.getProperty("remaimdername1"));

		utility.clickWithWait(sharespace_pages.bookmarkfileremaintersave);
		Thread.sleep(2000);
