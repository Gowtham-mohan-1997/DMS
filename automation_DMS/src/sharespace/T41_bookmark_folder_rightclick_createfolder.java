...
public class T41_bookmark_folder_rightclick_createfolder extends common_function{
	...
	public void s1_bookmark_createfolder() throws InterruptedException {
		...
		Thread.sleep(500);
		sharespace_pages.createfolderonbookmark.click();
		Thread.sleep(500);
		sharespace_pages.foldername.sendKeys(properties.getProperty("bookmarkfoldercreate"));
		Thread.sleep(500);
