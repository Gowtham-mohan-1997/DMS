...
public class T61_bookmark_file_rightclick_delete extends common_function{
	...
	public void s1_bookmark_file_delete() throws InterruptedException {
		...
		utility.clickWithWait(sharespace_pages.bookmarkfiledelete);

		utility.clickWithWait(sharespace_pages.deletepopup);
