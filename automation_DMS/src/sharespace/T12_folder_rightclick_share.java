...
public class T12_folder_rightclick_share extends common_function{
	...
	@Test
	public void s1_share_usingdropdown_onfolder() throws InterruptedException {
		...
		Thread.sleep(500);
		sharespace_pages.sharedropdownfolder.click();
		Thread.sleep(500);
		sharespace_pages.copylink.click();
		Thread.sleep(500);
