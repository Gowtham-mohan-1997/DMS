...
public class T56_bookmark_file_rightclick_sendto_sendtoproject extends common_function{
	...
	public void s1_bookmark_file_sendtoproject() throws InterruptedException {
		...
		utility.clickWithWait(sharespace_pages.bookmarkfilesendtoproject);
