...
public class T59_bookmark_file_rightclick_sendto_sendtopartner  extends common_function{
	...
	public void s1_bookmark_file_sendtopartner() throws InterruptedException {
		...
		utility.clickWithWait(Department_pages.bookmarkfilesendtopartner);
