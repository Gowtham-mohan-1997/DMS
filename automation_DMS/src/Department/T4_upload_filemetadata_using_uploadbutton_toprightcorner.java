...
public class T4_upload_filemetadata_using_uploadbutton_toprightcorner extends common_function{
	...
	@Test
	public void s1_uploadfilemetadata_usinguploadbutton() throws InterruptedException {
		...
		Thread.sleep(500);
		Department_pages.fileuploadmetadata.click();
		Thread.sleep(500);
		Department_pages.fileupload.sendKeys("/home/gautham/Documents/gowtham2.pdf");
		Thread.sleep(500);
		Department_pages.metadataapplyclose.click();
		Thread.sleep(500);
