...
public class T5_folder_rightclick_properties extends common_function{
	...
	public void s1_check_properties_onfolder() throws InterruptedException {
		...
		Thread.sleep(500);
		Department_pages.properties.click();
		Thread.sleep(500);
		String text = Department_pages.propertiesdata.getText();
		System.out.println("text" + text);
		Department_pages.advance.click();
		Thread.sleep(500);
		Department_pages.advancediscription.sendKeys("advance");
		Thread.sleep(500);
		Department_pages.advancediscriptionsave.click();
		Thread.sleep(500);
		String actualdata =Department_pages.actualelement.getText();
		System.out.println(actualdata);
		Department_pages.closebutton.click();
