...
public class T27_file_rightclick_lock extends common_function{
	...
	@Test
	public void s1_lock_unlock_onfile() throws InterruptedException {
		...
		action.contextClick(MyFiles_page.filepdf1).perform();
		Thread.sleep(500);
		Department_pages.lock.click();
		Thread.sleep(500);
		...
		action1.contextClick(MyFiles_page.filepdf1).perform();
		Thread.sleep(500);
		Department_pages.unlock.click();
		Thread.sleep(500);
