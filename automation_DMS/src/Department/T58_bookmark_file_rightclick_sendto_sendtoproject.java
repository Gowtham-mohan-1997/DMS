...
public class T58_bookmark_file_rightclick_sendto_sendtoproject  extends common_function{
	...
	public void s1_bookmark_file_sendtoproject() throws InterruptedException {
		...
		utility.clickWithWait(Department_pages.bookmarkfilesendtoproject);
