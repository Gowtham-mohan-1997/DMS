...
public class T60_bookmark_file_rightclick_sendto_sendtosharespace extends common_function{
	...
	@Test
	public void s1_bookmark_file_sharespace() throws InterruptedException {
		...
		utility.clickWithWait(Department_pages.bookmarkfilesendtosharespace);

		utility.clickWithWait(Department_pages.bookmarkfilesharespacefolderclick);
