...
public class T26_file_rightclick_rename extends common_function{
	...
	public void s1_rename_onfile() throws InterruptedException {
		...
		Thread.sleep(500);
		Department_pages.foldername.sendKeys(properties.getProperty("foldername4"));
		Thread.sleep(500);
		Department_pages.save.click();
		Thread.sleep(500);
		Department_pages.search.sendKeys(properties.getProperty("foldername4"));
		Thread.sleep(500);
		...
		Thread.sleep(500);
		Department_pages.renamedropdownonfile.click();
		Thread.sleep(500);
		Department_pages.foldernameinrename.clear();
		Thread.sleep(500);
		Department_pages.foldernameinrename.sendKeys(properties.getProperty("renamefile"));
		Thread.sleep(500);
