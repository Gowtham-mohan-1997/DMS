...
public class T7_folder_rightclick_createfolder extends common_function{
	...
	public void s1_createfolder_usingdropdown_onfolder() throws InterruptedException {
		...
		Thread.sleep(500);
		Department_pages.dropdownfoldercreate.click();
		Thread.sleep(500);
		Department_pages.foldercreatename.sendKeys(properties.getProperty("foldername1"));
		Thread.sleep(500);
		Department_pages.savebutton.click();
		Thread.sleep(500);
