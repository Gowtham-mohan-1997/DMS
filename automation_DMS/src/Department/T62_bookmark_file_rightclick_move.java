...
public class T62_bookmark_file_rightclick_move extends common_function{
	...
	public void s1_bookmark_file_move() throws InterruptedException {
		...
		utility.clickWithWait(Department_pages.bookmarkfilemoveandcopy);
		Thread.sleep(1000);
		utility.clickWithWait(Department_pages.folderclick1);

		utility.clickWithWait(Department_pages.movebutton);
