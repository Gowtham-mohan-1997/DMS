...
public class T33_file_rightclick_createremainder extends common_function{
	...
	public void s1_createremainder_onfile() throws InterruptedException {
		...
		action.contextClick(Department_pages.filepdf).perform();
		Thread.sleep(500);
		Department_pages.createremainteronfile.click();
		Thread.sleep(500);
		Department_pages.createremainternametextbox.sendKeys(properties.getProperty("remaindername"));
		Thread.sleep(500);
		Department_pages.createremaintercalender.click();
		Thread.sleep(500);
		Department_pages.createremaintercalenderdata.click();
		Thread.sleep(500);
		Department_pages.createremaintersavebutton.click();
		Thread.sleep(500);
