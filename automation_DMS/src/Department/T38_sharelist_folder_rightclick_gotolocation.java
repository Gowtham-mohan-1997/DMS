...
public class T38_sharelist_folder_rightclick_gotolocation extends common_function{
	...
	public void s1_sharelist_gotolocation() throws InterruptedException {
		...
		Thread.sleep(500);
		Department_pages.gotolocation.click();
		Thread.sleep(500);
		String actualdata =Department_pages.filenameingotolocation.getText();
