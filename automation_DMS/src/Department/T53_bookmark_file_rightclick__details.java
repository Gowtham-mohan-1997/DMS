...
public class T53_bookmark_file_rightclick__details extends common_function{
	...
	public void s1_bookmark_file_details() throws InterruptedException {
		...
		Department_pages.bookmarkfiledetails.click();

		String data =Department_pages.bookmarkfiledetailsdata.getText();
