...
public class T16_folder_rightclick_activitylog_verify_download extends common_function{
	...
	public void s1_activitylog_verify_download() throws InterruptedException {
		...
		Thread.sleep(500);
		Department_pages.downloadbutytonfolderactivity.click();
		Thread.sleep(500);
		Department_pages.csvdownloadfolderactivity.click();
		Thread.sleep(500);
		Department_pages.downloadbutytonfolderactivity.click();
		Thread.sleep(500);
		Department_pages.exceldownloadfolderactivity.click();
		Thread.sleep(500);
