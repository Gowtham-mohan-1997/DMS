...
public class T10_folder_rightclick_move extends common_function {
	...
	public void s1_move_dropdown_onfolder() throws InterruptedException {
		...
		Thread.sleep(500);
		Department_pages.foldername.sendKeys(properties.getProperty("foldername3"));
		Thread.sleep(500);
		Department_pages.save.click();
		Thread.sleep(2000);
		Department_pages.search.sendKeys(properties.getProperty("foldername3"));
		Thread.sleep(500);
		...
		Thread.sleep(500);
		Department_pages.movedropdownfolder.click();
		Thread.sleep(500);
		Department_pages.clickfoldermove.click();
		Thread.sleep(500);
