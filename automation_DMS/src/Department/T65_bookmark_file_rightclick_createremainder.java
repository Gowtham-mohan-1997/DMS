...
public class T65_bookmark_file_rightclick_createremainder extends common_function{
	...
	public void s1_bookmark_file_createremainder() throws InterruptedException {
		...
		utility.clickWithWait(Department_pages.bookmarkfileremainter);

		Department_pages.bookmarkfileremaintertext.sendKeys(properties.getProperty("remaimdername1"));

		utility.clickWithWait(Department_pages.bookmarkfileremaintersave);
		Thread.sleep(3000);
